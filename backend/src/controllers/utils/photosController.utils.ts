...
import * as conPagination from '@/constants/pagination.constants';
import * as conPhoto from '@/constants/photo.constants';
import * as conSorting from '@/constants/sorting.constants';
...
import * as typS3 from '@/types/types/s3.types';
...
export const uploadPhotoToS3 = async (file: Express.Multer.File): Promise<typS3.PhotoS3> => {
  ...
  const url = s3Middleware.getFileUrl(key);
